...
@section('content')
 ...
 <a href="{{route('image.create')}}"><button type="button" class="btn btn-block bg-gradient-success">Add</button></a>
              ...
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Title</th>
               ...
               <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td>{{$info->desc}}</td>
                  <td><img src="{{asset('images/'.$info->img)}}" width="60px" height="50px">
                  </td>
                  <td><a class="btn btn-app" href="{{route('image.create')}}">

                  <i class="fas fa-users"></i>Add
                </a></td>
                  <td><a class="btn btn-app" href="{{route('image.edit', $info->id )}}">
                  <i class="fas fa-edit"></i> Edit
                </a></td>
                <td>
                <form action="{{route('image.destroy',$info->id)}}" method="POST">
                @csrf
                @method('DELETE')
